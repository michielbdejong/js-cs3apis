...
goog.exportSymbol('proto.cs3.app.registry.v1beta1.AppProviderNameList', null, global);
 ...
 * @constructor
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.cs3.app.registry.v1beta1.AppProviderNameList.repeatedFields_, null);
};
goog.inherits(proto.cs3.app.registry.v1beta1.AppProviderNameList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cs3.app.registry.v1beta1.AppProviderNameList.displayName = 'proto.cs3.app.registry.v1beta1.AppProviderNameList';
}
 ...
 * @const
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.prototype.toObject = function(opt_includeInstance) {
  return proto.cs3.app.registry.v1beta1.AppProviderNameList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cs3.app.registry.v1beta1.AppProviderNameList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.toObject = function(includeInstance, msg) {
  var f, obj = {
    appProviderNameList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.cs3.app.registry.v1beta1.AppProviderNameList}
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cs3.app.registry.v1beta1.AppProviderNameList;
  return proto.cs3.app.registry.v1beta1.AppProviderNameList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cs3.app.registry.v1beta1.AppProviderNameList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cs3.app.registry.v1beta1.AppProviderNameList}
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cs3.app.registry.v1beta1.AppProviderNameList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cs3.app.registry.v1beta1.AppProviderNameList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAppProviderNameList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      1,
      f
 ...
 * @return {!Array<string>}
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.prototype.getAppProviderNameList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};


/** @param {!Array<string>} value */
proto.cs3.app.registry.v1beta1.AppProviderNameList.prototype.setAppProviderNameList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.prototype.addAppProviderName = function(value, opt_index) {
 ...
 * Clears the list making it empty but non-null.
 */
proto.cs3.app.registry.v1beta1.AppProviderNameList.prototype.clearAppProviderNameList = function() {
  this.setAppProviderNameList([]);
};
