...
function serialize_cs3_storage_registry_v1beta1_GetStorageProvidersRequest(arg) {
  if (!(arg instanceof cs3_storage_registry_v1beta1_registry_api_pb.GetStorageProvidersRequest)) {
    throw new Error('Expected argument of type cs3.storage.registry.v1beta1.GetStorageProvidersRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cs3_storage_registry_v1beta1_GetStorageProvidersRequest(buffer_arg) {
  return cs3_storage_registry_v1beta1_registry_api_pb.GetStorageProvidersRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_cs3_storage_registry_v1beta1_GetStorageProvidersResponse(arg) {
  if (!(arg instanceof cs3_storage_registry_v1beta1_registry_api_pb.GetStorageProvidersResponse)) {
    throw new Error('Expected argument of type cs3.storage.registry.v1beta1.GetStorageProvidersResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_cs3_storage_registry_v1beta1_GetStorageProvidersResponse(buffer_arg) {
  return cs3_storage_registry_v1beta1_registry_api_pb.GetStorageProvidersResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getStorageProviders: {
    ...
    requestType: cs3_storage_registry_v1beta1_registry_api_pb.GetStorageProvidersRequest,
    responseType: cs3_storage_registry_v1beta1_registry_api_pb.GetStorageProvidersResponse,
    requestSerialize: serialize_cs3_storage_registry_v1beta1_GetStorageProvidersRequest,
    requestDeserialize: deserialize_cs3_storage_registry_v1beta1_GetStorageProvidersRequest,
    responseSerialize: serialize_cs3_storage_registry_v1beta1_GetStorageProvidersResponse,
    responseDeserialize: deserialize_cs3_storage_registry_v1beta1_GetStorageProvidersResponse,
  },
