...
goog.exportSymbol('proto.cs3.sharing.ocm.v1beta1.ProviderInfo', null, global);
...
goog.exportSymbol('proto.cs3.sharing.ocm.v1beta1.UserShareList', null, global);
/**
 ...
 * @constructor
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.cs3.sharing.ocm.v1beta1.ProviderInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cs3.sharing.ocm.v1beta1.ProviderInfo.displayName = 'proto.cs3.sharing.ocm.v1beta1.ProviderInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.cs3.sharing.ocm.v1beta1.UserShareList.repeatedFields_, null);
};
goog.inherits(proto.cs3.sharing.ocm.v1beta1.UserShareList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cs3.sharing.ocm.v1beta1.UserShareList.displayName = 'proto.cs3.sharing.ocm.v1beta1.UserShareList';
}
 ...
 * @return {!Object}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.cs3.sharing.ocm.v1beta1.ProviderInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cs3.sharing.ocm.v1beta1.ProviderInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cs3.sharing.ocm.v1beta1.ProviderInfo;
  return proto.cs3.sharing.ocm.v1beta1.ProviderInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cs3.sharing.ocm.v1beta1.ProviderInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cs3.sharing.ocm.v1beta1.ProviderInfo}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cs3.sharing.ocm.v1beta1.ProviderInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cs3.sharing.ocm.v1beta1.ProviderInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDomain();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.getDomain = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.setDomain = function(value) {
 ...
 * @return {string}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.getApiVersion = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.setApiVersion = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.getApiEndpoint = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.setApiEndpoint = function(value) {
 ...
 * @return {string}
 */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.getWebdavEndpoint = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.cs3.sharing.ocm.v1beta1.ProviderInfo.prototype.setWebdavEndpoint = function(value) {
 ...
 * @const
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.toObject = function(opt_includeInstance) {
  return proto.cs3.sharing.ocm.v1beta1.UserShareList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cs3.sharing.ocm.v1beta1.UserShareList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.cs3.sharing.ocm.v1beta1.UserShareList}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cs3.sharing.ocm.v1beta1.UserShareList;
  return proto.cs3.sharing.ocm.v1beta1.UserShareList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cs3.sharing.ocm.v1beta1.UserShareList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cs3.sharing.ocm.v1beta1.UserShareList}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cs3.sharing.ocm.v1beta1.UserShareList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cs3.sharing.ocm.v1beta1.UserShareList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.cs3.identity.user.v1beta1.UserId}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.getUserId = function() {
  return /** @type{?proto.cs3.identity.user.v1beta1.UserId} */ (
...
/** @param {?proto.cs3.identity.user.v1beta1.UserId|undefined} value */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.setUserId = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.clearUserId = function() {
 ...
 * @return {boolean}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.hasUserId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.getUsersList = function() {
  return /** @type{!Array<!proto.cs3.identity.user.v1beta1.UserId>} */ (
    jspb.Message.getRepeatedWrapperField(this, cs3_identity_user_v1beta1_resources_pb.UserId, 2));
};


/** @param {!Array<!proto.cs3.identity.user.v1beta1.UserId>} value */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.setUsersList = function(value) {
 ...
 * @return {!proto.cs3.identity.user.v1beta1.UserId}
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.addUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.cs3.identity.user.v1beta1.UserId, opt_index);
};
 ...
 */
proto.cs3.sharing.ocm.v1beta1.UserShareList.prototype.clearUsersList = function() {
  this.setUsersList([]);
};
