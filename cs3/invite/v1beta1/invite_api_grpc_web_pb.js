/**
 * @fileoverview gRPC-Web generated client stub for cs3.invite.v1beta1
 * @enhanceable
 * @public
 */
...
var cs3_invite_v1beta1_resources_pb = require('../../../cs3/invite/v1beta1/resources_pb.js')
...
proto.cs3 = {};
proto.cs3.invite = {};
proto.cs3.invite.v1beta1 = require('./invite_api_pb.js');
 ...
 * @final
 */
proto.cs3.invite.v1beta1.InviteAPIClient =
 ...
 * @final
 */
proto.cs3.invite.v1beta1.InviteAPIPromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';
...
const methodDescriptor_InviteAPI_GenerateInviteToken = new grpc.web.MethodDescriptor(
  '/cs3.invite.v1beta1.InviteAPI/GenerateInviteToken',
  ...
  proto.cs3.invite.v1beta1.GenerateInviteTokenResponse.deserializeBinary
);
 ...
 */
proto.cs3.invite.v1beta1.InviteAPIClient.prototype.generateInviteToken =
 ...
 */
proto.cs3.invite.v1beta1.InviteAPIPromiseClient.prototype.generateInviteToken =
...
const methodDescriptor_InviteAPI_ForwardInvite = new grpc.web.MethodDescriptor(
  '/cs3.invite.v1beta1.InviteAPI/ForwardInvite',
  grpc.web.MethodType.UNARY,
  proto.cs3.invite.v1beta1.ForwardInviteRequest,
  proto.cs3.invite.v1beta1.ForwardInviteResponse,
  ...
  proto.cs3.invite.v1beta1.ForwardInviteResponse.deserializeBinary
);
 ...
 *     The XHR Node Readable Stream
 */
proto.cs3.invite.v1beta1.InviteAPIClient.prototype.forwardInvite =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/cs3.invite.v1beta1.InviteAPI/ForwardInvite',
      request,
 ...
 *     A native promise that resolves to the response
 */
proto.cs3.invite.v1beta1.InviteAPIPromiseClient.prototype.forwardInvite =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/cs3.invite.v1beta1.InviteAPI/ForwardInvite',
      request,
...
const methodDescriptor_InviteAPI_AcceptInvite = new grpc.web.MethodDescriptor(
  '/cs3.invite.v1beta1.InviteAPI/AcceptInvite',
  grpc.web.MethodType.UNARY,
  proto.cs3.invite.v1beta1.AcceptInviteRequest,
  proto.cs3.invite.v1beta1.AcceptInviteResponse,
  ...
  proto.cs3.invite.v1beta1.AcceptInviteResponse.deserializeBinary
);
 ...
 *     The XHR Node Readable Stream
 */
proto.cs3.invite.v1beta1.InviteAPIClient.prototype.acceptInvite =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/cs3.invite.v1beta1.InviteAPI/AcceptInvite',
      request,
 ...
 *     A native promise that resolves to the response
 */
proto.cs3.invite.v1beta1.InviteAPIPromiseClient.prototype.acceptInvite =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/cs3.invite.v1beta1.InviteAPI/AcceptInvite',
      request,
...
module.exports = proto.cs3.invite.v1beta1;
